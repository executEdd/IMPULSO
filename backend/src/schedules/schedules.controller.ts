...
export class SchedulesController {
  ...
  @ApiOperation({ summary: "Crear horario de clase (con validación de conflictos)" })
  @ApiCreatedResponse({ description: "Horario de clase creado exitosamente." })
  @ApiBadRequestResponse({ description: "Error en la validación de los datos enviados o conflicto detectado." })
  ...
  @ApiOkResponse({ description: "Listado completo de bloques de horario de la institución." })
  async findAll() {
  ...
  @ApiOperation({ summary: "Obtener horarios de clases asignados a un docente" })
  ...
  @ApiQuery({ name: "classroomId", type: Number, required: false, description: "ID del aula (opcional)" })
  ...
  @Put(":id")
  @Roles(UserRole.ADMIN)
  @ApiOperation({ summary: "Actualizar un bloque de horario (con validación de conflictos)" })
