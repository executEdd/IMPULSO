...
import { ApiTags, ApiOperation, ApiBearerAuth, ApiOkResponse, ApiCreatedResponse, ApiBadRequestResponse, ApiNotFoundResponse } from '@nestjs/swagger';
...
export class QrController {
  ...
  @ApiBadRequestResponse({ description: 'Perfil de estudiante no encontrado o error en autenticación.' })
